...
def PieCountbySeverity(request):
    ...
    if rows:
        #Construct the dictionary wtih severity level as keys and count as values 
...
result_with_month_names ={
    month_names[int(month)] : count for month, count int result.items()
}
